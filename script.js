...
gsap.from(".nlink",{
    stagger: .2,  // delay of .1 second in animation 
    y:10,
    duration:1,
    ease:Power2,
    opacity:0
...
document.querySelector(".footertext button").addEventListener("mouseleave",function(){
    gsap.to(".footer video",{
        opacity:0,
        duration:1.5,
        ease:Power4,
...
// sherry js to animate image accordingly